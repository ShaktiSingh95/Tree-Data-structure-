...
int balance()
{
    ...
    else if(copy->right==NULL&&copy->left!=NULL)
    {
        return copy->left->height;
    }
    else if(copy->left==NULL&&copy->right!=NULL)
    {
        return -(copy->right->height);
    }
    else
    {
        return ((copy->left->height)-(copy->right->height));
    }
}
void updateHeight()
{
...
int search(int value)
{
    ...
    else
    {
        if(value==copy->value)
        {
            printf("yes,%d is present at height %d with balance factor of %d:",value,copy->height,copy->balancef);
